...
const CONFIG: Record<string, BreakpointConfig> = {
  ...
  // Mobile: short runway. The sticky (image + label) is far shorter than the
  // viewport, so a long runway shows as a large empty off-white area below the
  // label. A compact ~80px runway drives the scrub and lets the next section
  // begin ~80-120px below the label instead of a full empty screen.
  mobile:  { count: 64, path: '/images/scroll-trigger/mobile/',  end: '+=80' },
};
