...
const projects: WorkProject[] = [
  ...
  {
    imageSrc: '/nlds/images/the-grooming-forge-barbershop-website-concept-nlds.webp',
    imageAlt: 'The Grooming Forge (Ironwood & Blade) premium barbershop website concept by New Level Design Studio',
    imageTitle: 'The Grooming Forge — Ironwood & Blade Barbershop Website Concept by New Level Design Studio',
    industry: 'Salons & Barbers',
    title: 'The Grooming Forge',
    problem: 'Local barbershop websites tend to default to generic templates or a bare listing page — no atmosphere, no motion, and no sense of the craft happening in the chair.',
    solution: 'A cinematic barbershop website concept for a fictional shop, Ironwood & Blade, built around a charcoal, bone, and ember-red editorial system, scroll-driven motion, grayscale-to-color team photography, and a booking path built entirely around getting into a chair.',
    deliverables: ['Cinematic hero entrance animation', 'Scroll-triggered section reveals', 'Grayscale-to-color team cards', 'Services, pricing & hours sections', 'Persistent mobile booking CTA', 'Reduced-motion support', 'Mobile-first responsive build'],
    classification: 'Concept Build',
  ...
  {
    imageSrc: '/nlds/images/liquid-legacy-pools-luxury-pool-website-concept-nlds.webp',
    imageAlt: 'Liquid Legacy Pools luxury pool design and construction website concept by New Level Design Studio',
    imageTitle: 'Liquid Legacy Pools — Luxury Pool Website Concept by New Level Design Studio',
    industry: 'Local Services',
    title: 'Liquid Legacy Pools',
    problem: 'Premium pool design-build companies sell six-figure outdoor environments, but most of their websites still look like a general contractor\'s — stock imagery, generic service grids, no sense of the craftsmanship or scale of the finished work.',
    solution: 'A premium pool-company website concept built around cinematic photography, an editorial project gallery with per-project specs, and a scroll-driven motion system pitched at the same level as the pools themselves.',
    deliverables: ['Full-bleed photographic hero', 'Editorial project gallery', 'Project detail pages with specs', 'Scroll-driven motion system', 'Process page', 'Mobile-first responsive build'],
    classification: 'Concept Build',
    demonstrates: 'Demonstrates a premium pool design and construction website built for high-ticket outdoor-living businesses.',
    slug: 'liquid-legacy-pools',
    demoUrl: 'https://liquid-legacy-pools-nlds.netlify.app',
    demoLabel: 'View Concept Website',
  },
  {
