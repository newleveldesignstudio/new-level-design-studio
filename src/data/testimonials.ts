...
// — a GBP data artifact, not the account holder's intended display name. The review
// text itself uses "our"/"we", and the underlying account covers both agents, so
// attribution credits both: Eileen Wynne and Joe Iaconis, Realtors at Worth Clark
// Realty (confirmed in the live Wynne-Iaconis Realty site build this studio
// produced for them). No reviewer photo is used — the only available image is her
// live Google avatar, which isn't ours to rehost.
export const testimonials: Testimonial[] = [
  {
    id: 'eileen-wynne-worth-clark-realty',
    name: 'Eileen Wynne & Joe Iaconis',
    business: 'Realtors, Worth Clark Realty',
    rating: 5,
